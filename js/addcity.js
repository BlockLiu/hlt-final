...
var provinceSet=["北京","上海","广东","江苏","浙江","重庆","安徽","福建","甘肃","广西",
    "贵州","海南","河北","黑龙江","河南","湖北","湖南","江西","吉林","辽宁","内蒙古",
    "宁夏","青海","山东","山西","陕西","四川","天津","新疆","西藏","云南","香港",
    "澳门","台湾","海外"];

var citySet=[["东城","西城","朝阳","丰台","石景山","海淀","门头沟","房山","通州","顺义","昌平","大兴","平谷","怀柔","密云","延庆"],
...
function getIndex(){
    ...
    for(var i=0;i<provinceSet.length;i++)
        if(provinceSet[i]==pro.value)
            return i;
}
...
function addcityoption(e){
    var index=getIndex();
    e.options.length=0;
    for (var i = 0; i < citySet[index].length; i++)
        e.add(new Option(citySet[index][i]));
}
